...
import { PCDLoader } from "./three/src/PCDLoader.js";
...
function init_2D(canvas_object, image_path) {
  ...
  datasource.onload = function () {
    ...
    // if (datasource.src.indexOf("lmi_technologies_cube_RGB.png") !== -1) {
    //   // fit image onto canvas
