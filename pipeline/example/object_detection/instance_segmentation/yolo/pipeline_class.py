...
class ModelPipeline(Base):
    ...
    def predict(self, configs: dict, inputs) -> dict:
        ...
        annotated_image = self.models['seg'].annotate_image(results_dict, image, colormap)
        
        # grab the results
        masks = results_dict['masks']   # binary masks
        segs = results_dict['segments'] # polygon segments
