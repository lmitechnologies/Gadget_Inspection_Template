...
dsts=[  '/app/image_archive/pipeline/nordson-pipeline/0/sensor/gadget-sensor-emulator/0',
        '/app/image_archive/pipeline/nordson-pipeline/0/sensor/gadget-sensor-emulator/1',
        '/app/image_archive/pipeline/nordson-pipeline/0/sensor/gadget-sensor-emulator/2'
    ]
