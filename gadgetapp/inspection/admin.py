...
from inspection.models import ConfigUI, UserSensorSelector, UserSensorConfig, UserAutomationSelector, UserAutomationConfig, UserPipelineSelector, UserPipelineConfig, SystemState, AvailableModels
...
admin.site.register(AvailableModels)
