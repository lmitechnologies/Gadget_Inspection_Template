...
&& cd LMI_AI_Solutions && git reset --hard 3147f94
...
# COPY ./tensorflow_addons-0.14.0-cp36-cp36m-linux_aarch64.whl .
# RUN pip3 install tensorflow_addons-0.14.0-cp36-cp36m-linux_aarch64.whl

#COPY opencv_python-4.6.0.66-cp36-abi3-manylinux_2_17_aarch64.manylinux2014_aarch64.whl .
#RUN pip3 install opencv_python-4.6.0.66-cp36-abi3-manylinux_2_17_aarch64.manylinux2014_aarch64.whl
